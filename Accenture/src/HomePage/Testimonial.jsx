function Testimonial() {
    return <div className="bg-black text-white">
        ...
        <div className="flex flex-col md:mt-20 md:ml-10 ml-2 mt-2 mr-2 md:flex-row gap-10 bg-black text-white p-10">
            <span className="  " > <img className=" md:w-140 md:h-100" src="https://images.pexels.com/photos/6195665/pexels-photo-6195665.jpeg">
            </img></span>
            <span className="flex flex-col gap-10 mt-10 w-100  font-bold" >
