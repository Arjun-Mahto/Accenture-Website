...
export default function HeroSection() {
  ...
  return (
    <div className="p-6 bg-black">
      ...
      <span className="mt-10 ml-3 w-160 flex flex-col gap-6"> <p className="font-bold text-5xl text-white">Reinvention isn’t optional—it’s how leaders stay ahead.</p>
